...
## Roadmap
1. **Skeleton** *(this repo, now)* — leader loads with placeholder art,
   working ability + agenda.
2. **Depth** — mementos, age-scaling, attribute tuning, hi_IN / bn_IN text.
3. **Art & polish** — portrait/icons, UI integration, quotes.
4. **Test & ship** — balance, compatibility, Steam Workshop release via the
